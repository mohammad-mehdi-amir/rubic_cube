...
class Rubic_Cube():
    def __init__(self,cube_obj):
        ...
        for rank,side in enumerate(tile_pos):
            for vec in side:
                tile = box(pos=vec,size=vector(0.98,0.98,0.1),color=colors[rank],emissive=True)
    ...
    def solution(self):
        solve(self.tiles,self.r_cube)
        
    
        
    def solve(self):
        values = solve(self.tiles,self.r_cube)
        ...
        for value in values:
            ...
            if lis_value[-1] == '2':
                ...
                self.moves.append(value)
    def control(self):
        button(bind=self.rotate_front_clock, text='F', width=80, height=30)
        button(bind=self.rotate_front_counter, text="F'", width=80, height=30)
        button(bind=self.rotate_right_clock, text='R', width=80, height=30)
        button(bind=self.rotate_right_counter, text="R'", width=80, height=30)
        button(bind=self.rotate_back_clock, text='B', width=80, height=30)
        button(bind=self.rotate_back_counter, text="B'", width=80, height=30)
        button(bind=self.rotate_left_clock, text='L', width=80, height=30)
        button(bind=self.rotate_left_counter, text="L'", width=80, height=30)
        button(bind=self.rotate_top_clock, text='U', width=80, height=30)
        button(bind=self.rotate_top_counter, text="U'", width=80, height=30)
        button(bind=self.rotate_bottom_clock, text='D', width=80, height=30)
        button(bind=self.rotate_bottom_counter, text="D'", width=80, height=30)
        button(bind=self.scramble, text='random_move', width=120, height=30)
        button(bind=self.solve, text='solution!', width=120, height=30)
